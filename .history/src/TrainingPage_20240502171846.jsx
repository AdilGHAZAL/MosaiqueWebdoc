  ...
  return (
    <div className="containerTraining">
      ...
      <div className="sectionMaterial">
        <h1>Séance 45'</h1>
        <img src="" alt="Icône séance" />
        <h2>Matériel</h2>
        <p>Tout ce dont vous avez besoin pour commencer:</p>
        <ul>
          <li><span className="icon">&#128095;</span> Chaussures de course</li>
          <li><span className="icon">&#127939;</span> Piste d'athlétisme (facultatif)</li>
        </ul>
      </div>

      <div className="sectionWarmUp">
        <img src="" alt="Icône échauffement" />
        <h2>Échauffement</h2>
        <div>
      ...
      <div className="sectionTraining">
        <img src="" alt="Icône entraînement" />
        <h2>Entraînement</h2>
        <div>
      ...
      <div className="sectionAdvice">
        <img src="" alt="Icône conseil" />
        <h2>Conseil</h2>
        <div>
          <p className="section-advice-paragraph">Tout ce dont vous avez besoin pour le bon déroulement:</p>
          <ul className="section-advice-list">
