...
import iconMosaique from "../assets/logoMosaique.svg";
import Cross from "../assets/cross.svg";
const Navbar = () => {
  ...
  return (
    <div className="navbar">
      <div className="logo-container">
        <a href="URL_of_the_first_logo" src={Cross} rel="noopener noreferrer">
          <img className="logo" src="./src/logos/logoMosaique.svg" alt="First Logo" />
        </a>
        <img className="cross-icon" src={Cross} alt="Cross Icon" />
        <a href="https://www.paris.fr" src={Cross} rel="noopener noreferrer">
