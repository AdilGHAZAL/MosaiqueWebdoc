...
import { collection, getDocs } from 'firebase/firestore'; // Ajout de l'import pour getDocs et collection
import { db } from './votre-chemin-vers-firebase-config'; // Assurez-vous d'importer votre configuration Firebase correctement
