  ...
  return (
    <div className="navbar">
      <div className="logo-container">
        <a href="URL_of_the_first_logo"  rel="noopener noreferrer">
          <img className="logo" src={iconMosaique} alt="First Logo" />
        </a>
        <img className="cross-icon" src={Cross} alt="Cross Icon" />
        <a href="https://www.paris.fr"  rel="noopener noreferrer">
          <img className="logo" src={iconVilleparis} alt="Second Logo" />
        </a>
      </div>
