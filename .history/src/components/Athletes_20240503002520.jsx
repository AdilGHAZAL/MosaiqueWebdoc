  ...
  return (
    <div className="containerAthletes">
      <div className="photoAthletes">
        ...
        <div class="overlay-text1">Le père de Leslie Djhone, Michel Djhone, était un sprinter de bon niveau. Il a participé aux Jeux Olympiques de 1972 à Munich, son père l’a inspiré à se mettre à l'athlétisme.</div>
      </div>
