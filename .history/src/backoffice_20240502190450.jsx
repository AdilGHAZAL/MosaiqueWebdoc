  ...
  return (
    ...
    <div style={{width:'100vw', padding:"22px"}}>
      ...
      <form style={{marginBottom:"20px"}} onSubmit={editingChampionId ? handleUpdateChampion : handleAddChampion}>
        <input style={{marginBottom:"20px"}} className='form-control' type="text" name="premiertexte" value={championData.premiertexte} onChange={handleInputChange} placeholder="premiertexte" required />
        <input style={{marginBottom:"20px"}} className='form-control' type="text" name="name" value={championData.name} onChange={handleInputChange} placeholder="name du champion" required />
        <input style={{marginBottom:"20px"}} className='form-control' type="url" name="url1" value={championData.url1} onChange={handleInputChange} placeholder="URL2 de l'icon du champion" required />
        <input style={{marginBottom:"20px"}} className='form-control' type="text" name="deuxiemetexte" value={championData.deuxiemetexte} onChange={handleInputChange} placeholder="deuxiemetexte du champion" required />
        <textarea style={{marginBottom:"20px"}} className='form-control' name="description" value={championData.description} onChange={handleInputChange} placeholder="Description du champion" required />
        <input style={{marginBottom:"20px"}} className='form-control' type="url" name="url2" value={championData.url2} onChange={handleInputChange} placeholder="URL2 de l'icon du champion" />
        <input style={{marginBottom:"20px"}} className='form-control' type="text" name="petitparagraphe1" value={championData.petitparagraphe1} onChange={handleInputChange} placeholder="petitparagraphe1 du champion" required />
        <input style={{marginBottom:"20px"}} className='form-control' type="text" name="grandparagraphe1" value={championData.grandparagraphe1} onChange={handleInputChange} placeholder="grandparagraphe1 du champion" required />
        <input style={{marginBottom:"20px"}} className='form-control' type="text" name="petitparagraphe2" value={championData.petitparagraphe2} onChange={handleInputChange} placeholder="petitparagraphe2 du champion" required />
        <input style={{marginBottom:"20px"}} className='form-control' type="text" name="grandparagraphe2" value={championData.grandparagraphe2} onChange={handleInputChange} placeholder="grandparagraphe2 du champion" required />
        <input style={{marginBottom:"20px"}} className='form-control' type="text" name="petitparagraphe3" value={championData.petitparagraphe3} onChange={handleInputChange} placeholder="petitparagraphe3 du champion" required />
