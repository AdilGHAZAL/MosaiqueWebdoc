  ...
  return (
    ...
    <div style={{width:'99vw'}}>
      ...
      <form onSubmit={editingChampionId ? handleUpdateChampion : handleAddChampion}>
        ...
        <input className='form-control' type="text" name="grandparagraphe3" value={championData.grandparagraphe3} onChange={handleInputChange} placeholder="grandparagraphe3 du champion" required />
