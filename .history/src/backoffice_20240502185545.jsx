  ...
  return (
    ...
    <div style={{width:'99vw'}}>
      ...
      <form onSubmit={editingChampionId ? handleUpdateChampion : handleAddChampion}>
        <input type="text" name="premiertexte" value={championData.premiertexte} onChange={handleInputChange} placeholder="premiertexte" required />
        <input type="text" name="name" value={championData.name} onChange={handleInputChange} placeholder="name du champion" required />
        <input type="url" name="url1" value={championData.url1} onChange={handleInputChange} placeholder="URL2 de l'icon du champion" required />
        <input type="text" name="deuxiemetexte" value={championData.deuxiemetexte} onChange={handleInputChange} placeholder="deuxiemetexte du champion" required />
        ...
        <input type="url" name="url2" value={championData.url2} onChange={handleInputChange} placeholder="URL2 de l'icon du champion" />
        <input type="text" name="petitparagraphe1" value={championData.petitparagraphe1} onChange={handleInputChange} placeholder="petitparagraphe1 du champion" required />
        <input type="text" name="grandparagraphe1" value={championData.grandparagraphe1} onChange={handleInputChange} placeholder="grandparagraphe1 du champion" required />
        <input type="text" name="petitparagraphe2" value={championData.petitparagraphe2} onChange={handleInputChange} placeholder="petitparagraphe2 du champion" required />
        <input type="text" name="grandparagraphe2" value={championData.grandparagraphe2} onChange={handleInputChange} placeholder="grandparagraphe2 du champion" required />
        <input type="text" name="petitparagraphe3" value={championData.petitparagraphe3} onChange={handleInputChange} placeholder="petitparagraphe3 du champion" required />
        <input type="text" name="grandparagraphe3" value={championData.grandparagraphe3} onChange={handleInputChange} placeholder="grandparagraphe3 du champion" required />
      ...
      <table>
        <thead>
          ...
          <th>premiertexte</th>
            ...
            <th>deuxiemetexte</th>
            <th>url2</th>
            <th>petitparagraphe1</th>
            <th>grandparagraphe1</th>
            <th>petitparagraphe2</th>
            <th>grandparagraphe2</th>
            <th>petitparagraphe3</th>
            <th>grandparagraphe3</th>
          </tr>
        </thead>
        <tbody>
